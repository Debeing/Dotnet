      ...
      <div className="ml-0 lg:ml-[calc((100%-80rem)/2)] lg:pl-8 space-y-6">
        ...
        <div className=" flex flex-nowrap gap-6 overflow-auto box-border no-scrollbar">
          <div className=" w-[270px] shrink-0 font-grotesk">
            ...
            <h4 className="font-bold text-[20px] leading-[110%] mt-4">
              1. Keynote
            </h4>
            <p className="font-[Lexend] font-light text-[16px] leading-[140%] tracking-normal mt-2">
              Doriane Mangamtcheuth Analyste M365 | Power Platform | Microsoft
              Dynamics 365
            </p>
          </div>
          <div className="w-[270px] shrink-0 font-grotesk mt-5">
            <div className="max-w-sm bg-[#0A855F]  h-[250px] rounded-2xl shadow-lg p-6">
              <p className="w-full h-full justify-center items-center flex  font-bold text-[34px] text-[#FFFFFF] ">
                Conf
                <span className=" text-[#ffffffa4]">ernce</span>
              </p>
            </div>
            <h4 className="font-bold text-[20px] leading-[110%] mt-4">
              2. Keynote
          ...
          <div className="w-[270px] shrink-0 font-grotesk">
            <div className="max-w-sm bg-[#E1A325]  h-[250px] rounded-2xl p-6">
              <p className="w-full h-full justify-center items-center flex  font-bold text-[34px] text-[#2D2006] ">
                Conf
                <span className=" text-[#2d20068b]">ernce</span>
              </p>
            </div>
            <h4 className="font-bold text-[20px] leading-[110%] mt-4">
              3. Copilot: prise en main de copilot sur Microsoft 365
            </h4>
            <p className="font-[Lexend] font-light text-[16px] leading-[140%] tracking-normal mt-2">
              Doriane Mangamtcheuth Analyste M365 | Power Platform | Microsoft
              Dynamics 365
          ...
          <div className="w-[270px] shrink-0 font-grotesk">
            <div className="max-w-sm bg-[#E1A325]  h-[250px] rounded-2xl p-6">
              <p className="w-full h-full justify-center items-center flex font-bold text-[34px] text-[#2D2006] ">
                Key
                <span className=" text-[#2d20068b]">note</span>
              </p>
            </div>
            <h4 className="font-bold text-[20px] leading-[110%] mt-4">
              5. Deploy .NET Aspire app to Kubernetes using Azure DevOps
              pipelines
            </h4>
